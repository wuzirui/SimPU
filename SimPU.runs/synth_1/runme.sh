...
HD_PWD='C:/Users/wuzirui/Desktop/VivadoProjects/SimPU/SimPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simpu.tcl
